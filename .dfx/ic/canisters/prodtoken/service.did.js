export const idlFactory = ({ IDL }) => {
  ...
  const Token = IDL.Service({
    'admin_init' : IDL.Func([], [], []),
    'admin_set_revenue_account' : IDL.Func([Account], [IDL.Bool], []),
    'admin_set_treasury_account' : IDL.Func([Account], [IDL.Bool], []),
    'admin_update_fee_split' : IDL.Func([IDL.Nat, IDL.Nat], [IDL.Bool], []),
    ...
    'get_fee_split' : IDL.Func(
        [],
        [IDL.Record({ 'burn' : IDL.Nat, 'treasury' : IDL.Nat })],
        ['query'],
      ),
    'get_revenue_info' : IDL.Func(
        [],
        [
          IDL.Record({
            'current_balance' : IDL.Nat,
            'last_swept_balance' : IDL.Nat,
            'treasury_account' : Account,
            'revenue_account' : Account,
            'available_to_sweep' : IDL.Nat,
          }),
        ],
        ['query'],
      ),
    ...
    'get_treasury_account' : IDL.Func([], [Account], ['query']),
