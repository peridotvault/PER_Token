...
export interface Token {
  ...
  'admin_set_revenue_account' : ActorMethod<[Account], boolean>,
  'admin_set_treasury_account' : ActorMethod<[Account], boolean>,
  'admin_update_fee_split' : ActorMethod<[bigint, bigint], boolean>,
  ...
  'get_fee_split' : ActorMethod<[], { 'burn' : bigint, 'treasury' : bigint }>,
  'get_revenue_info' : ActorMethod<
    [],
    {
      'current_balance' : bigint,
      'last_swept_balance' : bigint,
      'treasury_account' : Account,
      'revenue_account' : Account,
      'available_to_sweep' : bigint,
    }
  >,
  ...
  >,
  'get_treasury_account' : ActorMethod<[], Account>,
  ...
  'sweep_fees' : ActorMethod<[], undefined>,
